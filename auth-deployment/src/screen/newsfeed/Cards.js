...
import Image from "../../media/vegan-paella.jpg";
import { connect } from "react-redux";
// import Loading from "../../screen/";
import { GET_FOLLOWING, GET_POSTS } from "../../components/actions/actionTypes";
...
export const Cards = (props) => {
  ...
  return (
    <Card className={classes.root}>
      ...
      <CardMedia component="img" alt="vegan-paella.jpg" height="140" image={Image} title="Vegan Paella" />
